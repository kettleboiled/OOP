 ...
 * Переменная хранит имя и может быть использована в вычислениях, дифференцировании и упрощении выражений.
 */
public class Variable extends Expression {
     ...
     * Если переменная совпадает с заданным именем, возвращается единица, иначе ноль.
     *
     * @param varName Имя переменной, по которой производится дифференцирование.
     * @return Новое выражение, представляющее собой производную переменной.
     */
    @Override
    ...
    /**
     * Вычисляет значение переменной, подставив её значение из карты переменных.
     *
     * @param variables Карта, содержащая значения переменных.
     * @return Значение переменной.
     * @throws IllegalArgumentException Если переменная не найдена в карте.
     */
    @Override
