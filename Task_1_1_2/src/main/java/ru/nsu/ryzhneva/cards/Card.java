...
public class Card {
     ...
     * @throws IllegalArgumentException если передан недопустимый идентификатор масти
     *                                  или достоинства.
     */
     ...
     * Карты с числовым достоинством (2-10) возвращают свое значение.
     * Карты с картинками (Валет, Дама, Король) возвращают 10.
     *
     * @param flag если true - туз считается за 1, если false - за 11.
