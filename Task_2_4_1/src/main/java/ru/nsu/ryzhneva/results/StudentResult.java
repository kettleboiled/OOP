...
public class StudentResult {
    ...
    /**
     * Возвращает исходную модель студента.
     *
    ...
    /**
     * Возвращает коллекцию результатов задач.
     *
     * @return ассоциативный массив или словарь-отображение (Map) результатов
     *     прохождения задач для текущего студента. Ключом выступает идентификатор
     *     (id) задачи.
     */
    ...
    /**
     * Возвращает вычисленную активность студента.
     *
