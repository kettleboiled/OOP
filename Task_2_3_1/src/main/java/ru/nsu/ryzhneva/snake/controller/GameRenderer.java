...
public class GameRenderer {
    ...
    private static final Color COLOR_FIELD_NORMAL = Color.rgb(148, 206, 126);
    private static final Color COLOR_FIELD_ALTERNATE = Color.rgb(62, 195, 103);
    private static final Color COLOR_FOOD = Color.RED;
    private static final Color COLOR_SNAKE_BODY = Color.BLUEVIOLET;
    private static final Color COLOR_SNAKE_HEAD = Color.DARKSLATEBLUE;
    private static final Color COLOR_OVERLAY = Color.rgb(0, 0, 0, 0.7);
